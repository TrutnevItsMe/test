				...
				<div class="prices_block">
					<div class="cost prices clearfix">
						...
						<?}else{?>
							...
							{
								//echo "<pre>";var_dump($arResult['PRICE_MATRIX']);echo "<pre>";
								?>
...
<? include "set_composition.php";  /*?>
	<?if($arParams["SHOW_KIT_PARTS"] == "Y" && $arResult["SET_ITEMS"] AND (1==2)){?>
