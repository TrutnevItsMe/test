...
function showPrice(price) {
    ...
    //    + formatNumber(price.price, 0) + '</span><span class="price_currency"> ₽</span></span>'
    ...
    if (price.price < price.old) {
		...
		+'			<tbody><tr>'
		+'				<td rowspan="2"><span style="font-size: 33px;">'+formatNumber(price.price, 0)+' ₽</span></td>'
		+'				<td><span style=" padding-left: 8px;   color: #ff9900;    font-size: 18px;">-'+(formatNumber(price.old-price.price, 0))+' ₽</span></td>'
		+'			</tr>'
		+'			<tr>'
		+'				<td><s style="padding-left: 8px; color: #ccc;    font-size: 18px;">'+formatNumber(price.old, 0)+ ' ₽</s></td>'
		+'			</tr>'
		+'		</tbody></table>';
		
        //html += '<div class="price discount" data-currency="RUB" data-value="'
        //    + price.old + '"><span class="values_wrapper"><span class="price_value">'
        //    + formatNumber(price.old, 0) + '</span><span class="price_currency"> ₽</span></span></div>';
        ...
        //    + formatNumber(price.old-price.price, 0)
        //    + '</span><span class="price_currency">&nbsp; ₽</span></span></div>';
