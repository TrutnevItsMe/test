	...
	*/
	...
	<div style="position:relative; display: block; width:100%;">
		...
		if (strLen($arResult["CAPTCHA_CODE"]) > 0):
			...
			<div class="reviews-reply-field reviews-reply-field-captcha">
				...
				<div class="reviews-reply-field-captcha-label">
					<label for="captcha_word"><?=GetMessage("F_CAPTCHA_PROMT")?><span class="reviews-required-field star">*</span></label>
		...
		<div class="reviews-reply-buttons">
			<input name="send_button" type="submit" class="btn btn-default" value="<?=GetMessage("OPINIONS_SEND")?>" tabindex="<?=$tabIndex++;?>" <?
			?>onclick="this.form.preview_comment.value = 'N';" />
			<input name="view_button" type="submit" class="btn btn-default white" value="<?=GetMessage("OPINIONS_PREVIEW")?>" tabindex="<?=$tabIndex++;?>" <?
