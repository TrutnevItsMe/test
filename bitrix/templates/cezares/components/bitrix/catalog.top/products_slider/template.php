						...
						<li id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="catalog_item visible">
							<div class="inner_wrap">
								<div class="image_wrapper_block">
									...
									<div class="fast_view_block" data-event="jqm" data-param-form_id="fast_view" data-param-iblock_id="<?=$arParams["IBLOCK_ID"];?>" data-param-id="<?=$arItem["ID"];?>" data-param-fid="<?=$this->GetEditAreaId($arItem['ID']);?>" data-param-item_href="<?=urlencode($arItem["DETAIL_PAGE_URL"]);?>" data-name="fast_view"><?=$fast_view_text;?></div>
								</div>
								<div class="item_info">
