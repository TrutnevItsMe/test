...
<div class="menu middle">
	<ul>
		<li<?=(CNext::isPersonalPage() ? ' class="selected"' : '')?>>
			<?$link = str_replace('//', '/', str_replace('/', SITE_DIR, \Bitrix\Main\Config\Option::get('aspro.next', 'PERSONAL_PAGE_URL', SITE_DIR.'personal/')));?>
			<?if(\Bitrix\Main\Loader::includeModule('aspro.next')):?>
				<?$link = CNext::GetFrontParametrValue('PERSONAL_PAGE_URL')?>
			<?endif;?>
