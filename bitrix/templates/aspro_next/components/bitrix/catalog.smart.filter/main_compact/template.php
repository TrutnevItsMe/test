...
if($arResult["ITEMS"]){?>
	<div class="bx_filter bx_filter_vertical compact swipeignore fill_<?=$arParams["FILL_COMPACT_FILTER"];?>">
		<div class="bx_filter_section clearfix">
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				<div class="bx_filter_parameters_box active title">
					<div class="bx_filter_parameters_box_title filter_title"><?=Loc::getMessage("FILTER_TITLE_COMPACT");?></div>
				</div>
								...
								if(isset($arItem["PRICE"])):
									...
									?>
										<div class="price_block swipeignore">
											<div class="bx_filter_parameters_box_title icons_fa prices"><?=(count($arParams['PRICE_CODE']) > 1 ? $arItem["NAME"] : Loc::getMessage("PRICE"));?></div>
					...
					<div class="bx_filter_button_box active hidden">
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container clearfix">
								...
								<input class="bx_filter_search_button btn btn-default pull-left" type="submit" id="set_filter" name="set_filter" data-href="" value="<?=Loc::getMessage("CT_BCSF_SET_FILTER")?>" />
