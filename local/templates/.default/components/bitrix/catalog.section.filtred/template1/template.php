...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"><div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
		<a onclick="yaCounter20631445.reachGoal('SALE');" id="<? echo $arItemIDs['PICT']; ?>"
			href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
			class="bx_catalog_item_images"
			style="background-image: url(<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>)"
			title="<? echo $strTitle; ?>"><?
			
	if ('Y' == $arItem['PROPERTIES']['PREMIUM']['VALUE_XML_ID'])
	{
	?>
		<div
			class="bx_stick_disc right top"
			style="font-size: 12px;">Премиум!</div>
	<?
	}
	...
	{
		?><a onclick="yaCounter20631445.reachGoal('SALE');" id="<? echo $arItemIDs['SECOND_PICT']; ?>"
			href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
	...
	<div class="bx_catalog_item_title">
		<a onclick="yaCounter20631445.reachGoal('SALE');" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $arItem['NAME']; ?>"><? echo $arItem['NAME']; ?></a>
	</div>
