...
$MESS["REGION_BLOCK_NAME_DEFAULT"] = "Контрагент и соглашения";
...
$MESS["ORDER_DRAFT_DEFAULT"] = "Сохранить черновик";
...
$MESS["SELECT_PROFILE_DEFAULT"] = "Выберите партнера";
...
$MESS["SUCCESS_PRELOAD_TEXT_DEFAULT"] = "ПРОВЕРЬТЕ ВЫБОР КОНТРАГЕНТА И СОГЛАШЕНИЕ.<br />
ЕСЛИ ВСЁ ВЫБРАНО ПРАВИЛЬНО НАЖМИТЕ ОФОРМИТЬ ПРЕДВАРИТЕЛЬНЫЙ ЗАКАЗ.
";
...
$MESS["ORDER_ITEMS"] = "Товары в заказе";
$MESS["EDIT_ORDER"] = "Изменить заказ";
$MESS["RESTS"] = "Остатки";
