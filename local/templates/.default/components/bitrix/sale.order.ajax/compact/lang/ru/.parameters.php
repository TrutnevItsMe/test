...
$MESS["ACTIVE_SAVE_DRAFT_ORDER"] = "Активировать кнопку 'Сохранить как черновик'";
$MESS["INDEX_PICTURE"] = "Индекс вывода изображения в таблице";
$MESS["SHOW_STORE"] = "Выводить склад";
$MESS["SHOW_RESTS"] = "Выводить остатки";
$MESS["DEF_STORE_ID"] = "Склад по умолчанию";
?>