...
<div class="module-form-block-wr lk-page">
	...
	<? if ($arParams["MANAGERS_ONLY"] != "Y") : ?>
		<div class="form-block-wr">
			<? if ($arResult["SHOW_SMS_FIELD"] && !$arResult["strProfileError"]): ?>
				<form method="post" name="form1" class="main" action="<?= $arResult["FORM_TARGET"] ?>?"
					...
					<div class="but-r">
						<button class="btn btn-default" type="submit" name="code_submit_button" value="Y">
							<span><?= GetMessage("main_profile_send") ?></span></button>
					</div>
			...
			<? else: ?>
				<form method="post" name="form1" class="main" action="<?= $arResult["FORM_TARGET"] ?>?"
						...
						<div class="form-control">
							<div class="wrap_md">
								<div class="iblock label_block">
									...
									<input required type="text" name="LOGIN" required
						...
						<div class="form-control">
							<div class="wrap_md">
								<div class="iblock label_block">
									...
									?>
									<input <?= ($arResult['PHONE_REQUIRED'] ? 'required' : '') ?> type="tel"
																								  name="PHONE_NUMBER"
																								  class="phone"
																								  maxlength="255"
					...
					<? endif; ?>
					<div class="but-r">
						<button class="btn btn-default" type="submit" name="save" value="Y">
							<span><?= (($arResult["ID"] > 0) ? GetMessage("MAIN_SAVE_TITLE") : GetMessage("MAIN_ADD_TITLE")) ?></span>
						</button>
					</div>
				</form>
			<? endif; ?>
