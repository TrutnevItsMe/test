...
<?if( count( $arResult["ITEMS"] ) >= 1 ){?>
	...
	<div class="top_wrapper items_wrapper">
		...
		<?foreach($arResult["ITEMS"] as $arItem){?>
            ...
            $totalCount = $arItem['PRODUCT']['QUANTITY'];
			...
			?>
            <?php if($totalCount): ?>
                <div class="col-m-20 col-lg-<?=$col;?> col-md-4 col-sm-<?=floor(12 / round($arParams['LINE_ELEMENT_COUNT'] / 2))?> item item_block" data-col="<?=$col;?>">
