...
<script id="basket-item-table-props-template" type="text/html">
						...
						switch (trim((string)$blockName))
						{
							case 'props':
								if (in_array('PROPS', $arParams['COLUMNS_LIST']))
								{
									?>
                                    {{#PROPS}}
                                    <td class="td-basket-item-property td-basket-item-property-{{CODE}}">
        ...
        <tr class="basket-header" id="basket-header">
            ...
            {{/SHOW_RESTORE}}
            <td>
                <div class="basket-items-list-item-descriptions-header">
